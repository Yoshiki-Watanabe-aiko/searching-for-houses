...
--
-- MINIMINI は一覧ページが reCAPTCHA のボット判定下にあり HTTP では取得できない。
-- 回避はしない方針のため Phase 3（Playwright 展開）で改めて扱いを判断する。
-- ============================================================
...
INSERT INTO m_sites (
    ...
    ('MINIMINI',   'minimini',        'https://minimini.jp',       'HTTP',       TRUE,  2.5, 5, NULL,  80, '一覧ページがreCAPTCHAのボット判定下。HTTPでは取得不可。Phase 3 で扱いを再判断する'),
