...
- **賃貸のスクレイピング対象は15サイト**（SHAMAISON・LEOPALACE を除く）。マスタ行数は17。
...
- アダプタ実装済みは **MINIMINI を除く15サイト**（既存10 ＋ Phase 5F の UR ＋ Phase 5G のレオパレス21 ＋ Phase 5H の D-room・ハウスコム・ホームメイト）。
...
| `m_sites` | サイト（17行。取得方式・レート制御・代表選定優先順） |
